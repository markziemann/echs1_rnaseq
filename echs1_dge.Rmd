...
5. CON ut vs KO dNs. (what was altered in ECHS1 KO, that has been returned to normal levels (and no longer significantly different) to 
CON ut).
...
maplot(dge5,"Cont5: Effect of drug in KO cells")
make_volcano(dge5,"Cont5: Effect of drug in KO cells")
make_volcano2(dge5,"Cont5: Effect of drug in KO cells")
make_heatmap(dge5,"Cont5: Effect of drug in KO cells",ss5,xx5,n=50)
make_heatmap2(dge5,"Cont5: Effect of drug in KO cells",ss5,xx5,n=50)
